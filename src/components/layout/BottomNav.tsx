...
const BottomNav: React.FC = () => {
  const { currentScreen, setScreen, gameStatus, resetGame } = useGameStore();
  ...
  return (
    <nav className="absolute bottom-0 left-0 w-full z-50 flex justify-around items-center px-6 pb-8 pt-4 bg-parlor-surface/95 backdrop-blur-md border-t border-parlor-primary/5">
      ...
      >
        ...
        <span className="text-[10px] font-bold font-sans uppercase tracking-widest whitespace-nowrap">HIGH SCORES</span>
      </button>
    </nav>
  );
};
